			...
			<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    <div class='card-header'>
				        <h5>Stai modificando il regista: </h5> 
				    </div>
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteModificaRegistaServlet" class="row g-3" novalidate="novalidate">
							
								<input type="hidden" name ="idRegista" value="${update_regista_attr.id}">
							
								<div class="col-md-6">
									<label for="nome" class="form-label">Nome <span class="text-danger">*</span></label>
									<input type="text" name="nome" id="nome" class="form-control" placeholder="inserisci il nome"
										value="${update_regista_attr.nome}" required>
								</div>
								
								<div class="col-md-6">
									<label for="cognome" class="form-label">Cognome <span class="text-danger">*</span></label>
									<input type="text" name="cognome" id="cognome" class="form-control" placeholder="Inserire il cognome"  
										value="${update_regista_attr.cognome}" required>
								</div>
							
								<div class="col-md-6">
									<label for="altezza" class="form-label">Nickname <span class="text-danger">*</span></label>
									<input type="text" name="nickName" id="nickName" class="form-control" placeholder="Inserire il nickName" 
									value="${update_regista_attr.nickName}" required>
								</div>
								...
								<div class="col-md-6">
									<label for="altezza" class="form-label">Sesso <span class="text-danger">*</span></label>
									 <select class="form-control" id="sesso" name="sesso" required>
								    	<option value="${update_regista_attr.sesso.abbreviazione}" selected> - Selezionare - </option>
