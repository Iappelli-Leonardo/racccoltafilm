				                ...
				                <tbody>
				                	<c:forEach items="${registi_list_attribute }" var="registaItem">
										<tr>
											...
											<td>
												<a class="btn  btn-sm btn-outline-secondary" href="ExecuteVisualizzaRegitsaServlet?idRegista=${registaItem.id }">Visualizza</a>
												<a class="btn  btn-sm btn-outline-primary ml-2 mr-2" href="PrepareModificaRegistaServlet?idRegista=${registaItem.id }">Modifica</a>
