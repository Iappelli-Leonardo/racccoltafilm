	...
	<main class="flex-shrink-0">
			  ...
			  <div class='card'>
				    ...
				    <div class='card-body'>
							...
							<form method="post" action="ExecuteVisualizzaUtenteServlet" class="row g-3" >
							
							
							<div class="col-md-6">
									<label>Username <span class="text-danger">*</span></label>
									<input type="text" class="form-control" name="username" id="username" placeholder="Inserire username" value="${utente_attr.username }" >
								</div>
